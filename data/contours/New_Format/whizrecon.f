...
CCCCCC CHICAGO.  QUESTIONS SHOULD BE DIRECTED TO ANN LOTTES AT (312)702-8146
CCCCCC	
	PROGRAM WHIZRECON
	DIMENSION ROT(999,5),IROT(999) 
        ...
        CHARACTER*80 NAME
        CHARACTER*80 NAM2
	CHARACTER*1 REFNUM(3)
	CHARACTER*1 ICH(3),LTYP(3),TYPE(2)
	CHARACTER*1 TCH(3)
	CHARACTER*1 FCHN
	CHARACTER*1 TAB
...
340       CONTINUE
       NEWCNT=NEWCNT+1
C       READ(4,1004,ERR=370,END=390)REFNUM,NEWSEQ,ID,INC,
C     *IT1,IT2,TYPE,LTYP,ICOL
       READ(4,10004,ERR=370,END=390)REFNUM,NEWSEQ,ID,INC,
     *IT1,IT2
...
18      CONTINUE
        JCNT=ICNT-1
        WRITE(2,1114)JCNT,TAB,JCNT,TAB,ID,TIME,NAME
        DO 20 I=1,JCNT
...
1020       FORMAT(1I3)
1105    FORMAT(1X,1A3)
1114	FORMAT(1X,I4,A1,I4,1A1,I3,1X,F5.1,1A40)
CCCCCC
       STOP
       END
