	PROGRAM ISOCHRON
C		VARIABLES SET UP
	real INIT,IFINT,IDUR,INUM,ITIM,IT1,IT2
...
31	CONTINUE
	...
	INC=200
	TYPE='IC'
	if(IT2.le.20.0) LTYP=-2600.0-365.0*sqrt(IT2)
	if(IT2.gt.20.0) LTYP=-5651+2473*exp(-0.0278*IT2)
C	LTYP='000'
	ICOL=7
	IF (LTYP.LE.-2600..and.LTYP.GT.-3000.) ICOL=1
	IF (LTYP.LE.-3000..and.LTYP.GT.-3500.) ICOL=6
	IF (LTYP.LE.-3500..and.LTYP.GT.-4000.) ICOL=5
	IF (LTYP.LE.-4000..and.LTYP.GT.-4500.) ICOL=4
	IF (LTYP.LE.-4500..and.LTYP.GT.-5000.) ICOL=3
	IF (LTYP.LE.-5000..and.LTYP.GT.-5500.) ICOL=2
	IF (LTYP.LE.-5500..and.LTYP.GT.-5700.) ICOL=1
       WRITE(2,1004)REFNUM,NEWSEQ,ID,INC,
     *IT1,IT2,TYPE,LTYP,ICOL
C       WRITE(6,1004)REFNUM,NEWSEQ,ID,INC,
...
33	CONTINUE
	READ(4,*,END=36)
32	CONTINUE
C	READ(4,2,END=36) ALAT,ALONG,IPEN
	READ(4,*,END=36) ALAT,ALONG,IPEN
