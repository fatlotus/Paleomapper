...
CCCCCC
	...
	TYPE *, ' '
	TYPE *, 'THIS PROGRAM "reCONCATENATES" POLES OF ROTATION'
	TYPE*, ' ENTER first INPUT FILE NAME'
	READ(5,1)NAME
1	FORMAT(1A80)
	OPEN(UNIT=2,NAME=NAME,TYPE='OLD')
	TYPE*, ' ENTER second INPUT FILE NAME'
	READ(5,1)NAME
...
10	CONTINUE
	READ(2,*,END=999)ID1,TIME1,ALAT1,ALONG1,ANG1,ID3
C	WRITE(3,2)ID1,TIME,ALAT1,ALONG1,ANG1,ID2
	ANG1=-ANG1
15	CONTINUE
	READ(4,*,END=999)ID2,TIME2,ALAT2,ALONG2,ANG2,ID3
	IF (TIME1.NE.TIME2) go to 15
	IF ((TIME1.EQ.TIME2).AND.(ANG1.EQ.0.0).AND.(ANG2.EQ.0.0)) THEN
         ROTLAT=ALAT2
         ROTLO=ALONG2
         ROTAN=ANG2
           GO TO 17
     ...
     * ROTLAT,ROTLO,ROTAN)
17	WRITE(3,2)ID1,TIME1,ROTLAT,ROTLO,ROTAN,ID2
